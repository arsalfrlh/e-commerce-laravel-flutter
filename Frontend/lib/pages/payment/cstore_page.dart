...
class CstorePage extends StatefulWidget {
  CstorePage({required this.payment, required this.beli});
  Payment payment;
  Beli beli;
...
class _CstorePageState extends State<CstorePage> {
  ...
  void initState() {
    ...
    if(widget.payment.store == 'alfamart'){
      storeController = TextEditingController(text: "Alfamaret");
    }else if(widget.payment.store == 'indomaret'){
      storeController = TextEditingController(text: "Indomaret");
    }else{
      storeController = TextEditingController(text: "Error");
    }
  }
      ...
      if(response['success'] == true){
        if(response['data']['transaction_status'] == 'settlement'){
          ...
          AwesomeDialog(
            ...
            desc: 'Silahkan lakukan pembayaran anda dengan ${storeController.text}',
            btnOkOnPress: (){},
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("CStore Payment"),
      ),
      body: SafeArea(
        child: SizedBox(
...
class SignUpForm extends StatelessWidget {
  SignUpForm({required this.nmBarang, required this.jumlah, required this.total, required this.store, required this.paymentCode, required this.expire, required this.status});
  final TextEditingController nmBarang, jumlah, total, store, paymentCode, expire;
