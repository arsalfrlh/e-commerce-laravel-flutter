...
import 'package:latihan/pages/barang/barang_page.dart';
...
import 'package:latihan/pages/barang/search_page.dart';
import 'package:latihan/pages/barang/tambah_page.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              SpecialOffers(
                seemore: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => BarangPage())).then((_) => fetchBarang());
                },
                onPress: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => BarangPage())).then((_) => fetchBarang());
                },
...
class HomeHeader extends StatelessWidget {
  ...
  final VoidCallback tambah, logout, onFetch;
      ...
      child: Row(
        ...
        children: [
          ...
          IconBtnWithCounter(
            svgSrc: cartIcon,
            press: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => PemebelianPage())).then((_) => onFetch());
            },
          ),
...
class SearchField extends StatelessWidget {
  const SearchField({required this.onFetch});
    ...
    return Form(
      child: TextFormField(
        onFieldSubmitted: (value) {
          Navigator.push(context, MaterialPageRoute(builder: (context) => SearchPage(cari: value))).then((_) => onFetch());
        },
...
class Categories extends StatelessWidget {
  Categories({required this.onFetch});
      ...
      child: Row(
        ...
        children: List.generate(
          ...
          (index) => CategoryCard(
            ...
            press: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => BarangPage())).then((_) => onFetch());
            },
          ),
        ),
      ),
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: [
              SpecialOfferCard(
                image: 'assets/images/rtx.jpg', //lokasi file dan nama file di simpan di String dan di panggil di dalma class SpecialOfferCard
                category: "Nvdia RTX",
                numOfBrands: 10,
                press: onPress,
              ),
      ...
      child: GestureDetector(
        ...
        child: SizedBox(
          ...
          child: ClipRRect(
            ...
            child: Stack(
              children: [
                Image.asset( //gunakan Image.asset untuk memunculkan gambar dalam assets flutter
                  image,
                  width: double.infinity,
...
class PopularProducts extends StatelessWidget {
  PopularProducts({required this.barangList, required this.seemore});
  List<Barang> barangList;
  final VoidCallback seemore;
                ...
                (index) {
                    return Padding(
                      ...
                      child: ProductCard(
                        ...
                        onPress: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => BeliPage(barang: barangList[index])));
                        },
                      ),
                    );
                },
          ...
          children: [
            AspectRatio(
              ...
              child: Container(
                ...
                child: CachedNetworkImage(imageUrl: 'http://10.0.2.2:8000/images/${barang.gambar}', fit: BoxFit.cover, errorWidget: (context, url, error) => Icon(Icons.broken_image, size: 50,),)
              ),
            ),
